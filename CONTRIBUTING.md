...
- **3.3.5**: Stable development branch for WotLK
...
1. **Create a branch** from `3.3.5` for your changes
...
Before reporting a bug, make sure you are using the latest core and database revision.
...
- **Branch**: `3.3.5`
- **Commit hash**: The full commit hash (not "unknown" or "archived")
...
The quest "The Collapse" (https://www.wowhead.com/wotlk/quest=11706)
