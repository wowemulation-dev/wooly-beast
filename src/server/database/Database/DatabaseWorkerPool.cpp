...
#define MIN_MYSQL_CLIENT_VERSION_STRING "8.0"

#define MIN_MARIADB_SERVER_VERSION 100600u
#define MIN_MARIADB_SERVER_VERSION_STRING "10.6"
#define MIN_MARIADB_CLIENT_VERSION 30303u
#define MIN_MARIADB_CLIENT_VERSION_STRING "3.3.3"
#endif
