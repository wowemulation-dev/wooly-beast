...
class TC_DATABASE_API LoginDatabaseConnection : public PostgreSQLConnection
{
public:
    typedef LoginDatabaseStatements Statements;

    LoginDatabaseConnection(PostgreSQLConnectionInfo& connInfo, ConnectionFlags connectionFlags);
