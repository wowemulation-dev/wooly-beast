...
HotfixDatabaseConnection::HotfixDatabaseConnection(PostgreSQLConnectionInfo& connInfo, ConnectionFlags connectionFlags) : PostgreSQLConnection(connInfo, connectionFlags)
{
}
