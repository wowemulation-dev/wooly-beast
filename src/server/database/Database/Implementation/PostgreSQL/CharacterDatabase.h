...
#ifndef _POSTGRESQLCHARACTERDATABASE_H
#define _POSTGRESQLCHARACTERDATABASE_H
...
class TC_DATABASE_API PostgreSQLCharacterDatabaseConnection : public PostgreSQLConnection
{
public:
    typedef CharacterDatabaseStatements Statements;

    //- Constructors for sync and async connections
    PostgreSQLCharacterDatabaseConnection(PostgreSQLConnectionInfo& connInfo);
    PostgreSQLCharacterDatabaseConnection(ProducerConsumerQueue<SQLOperation*>* q, PostgreSQLConnectionInfo& connInfo);
    ~PostgreSQLCharacterDatabaseConnection();
