...
class TC_DATABASE_API CharacterDatabaseConnection : public PostgreSQLConnection
{
public:
    typedef CharacterDatabaseStatements Statements;

    CharacterDatabaseConnection(PostgreSQLConnectionInfo& connInfo, ConnectionFlags connectionFlags);
