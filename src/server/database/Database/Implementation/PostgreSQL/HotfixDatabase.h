...
class TC_DATABASE_API HotfixDatabaseConnection : public PostgreSQLConnection
{
public:
    typedef HotfixDatabaseStatements Statements;

    HotfixDatabaseConnection(PostgreSQLConnectionInfo& connInfo, ConnectionFlags connectionFlags);
