...
class TC_DATABASE_API WorldDatabaseConnection : public PostgreSQLConnection
{
public:
    typedef WorldDatabaseStatements Statements;

    WorldDatabaseConnection(PostgreSQLConnectionInfo& connInfo, ConnectionFlags connectionFlags);
